...
clear
echo -e "[ ${tyblue}NOTES${NC} ] SEDANG MENGINSTAL AUTO SCRIPT HARAP TUNGGU .... "
sleep 1
echo -e "[ ${tyblue}NOTES${NC} ] MULTI PORT MULTI PATH "
sleep 2
echo -e "[ ${green}INFO${NC} ] BY RVPN PREMIUM"
sleep 1
echo -e "[ ${green}INFO${NC} ] t.me/RVPNSTORES"
sleep 5
...
echo -e "[ ${green}INFO${NC} ] INSTALL BY RVPN PREMIUM "
apt install git curl -y >/dev/null 2>&1
echo -e "[ ${green}INFO${NC} ] FILE SUDAH READY "
sleep 2
...
echo ""
wget -q https://raw.githubusercontent.com/rizkyckj/SSH-XRAY/main/data/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/rizkyckj/SSH-XRAY/main/data/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Install Xray
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/rizkyckj/SSH-XRAY/main/data/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/rizkyckj/SSH-XRAY/main/data/insshws.sh && chmod +x insshws.sh && ./insshws.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/rizkyckj/SSH-XRAY/main/data/ohp.sh && chmod +x ohp.sh && ./ohp.sh
#Install AutoBackup
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/rizkyckj/SSH-XRAY/main/data/set-br.sh && chmod +x set-br.sh && ./set-br.sh
#Download Extra Menu
echo -e "${tyblue}.------------------------------------------.${NC}"
echo -e "${tyblue}|           DOWNLOAD EXTRA MENU            |${NC}"
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget https://raw.githubusercontent.com/rizkyckj/SSH-XRAY/main/data/update.sh && chmod +x update.sh && ./update.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/rizkyckj/SSH-XRAY/main/data/version  )
...
wget -q -O /usr/bin/clear-log raw.githubusercontent.com/rizkyckj/Autoscript/main/xray/clear-log
chmod +x /usr/bin/clear-log; cd
wget -q raw.githubusercontent.com/rizkyckj/Autoscript/main/addons/crontab.sh
