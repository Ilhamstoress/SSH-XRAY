...
locality=Bandung 
organization=RVPN 
organizationalunit=RVPN 
commonname=RVPN 
email=rizkyckj7@gmail.com

# simple password minimal
curl -sS https://raw.githubusercontent.com/rizlyckj/SSH-XRAY/main/data/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
