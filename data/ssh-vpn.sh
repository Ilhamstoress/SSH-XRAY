...
curl -sS https://raw.githubusercontent.com/Ilhamstoress/SSH-XRAY/main/data/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget https://raw.githubusercontent.com/Ilhamstoress/SSH-XRAY/main/data/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
#fi
...
# download script
cd /usr/bin
wget -O speedtest "https://raw.githubusercontent.com/Ilhamstoress/SSH-XRAY/main/data/speedtest_cli.py"
wget -O xp "https://raw.githubusercontent.com/Ilhamstoress/SSH-XRAY/main/data/xp.sh"
wget -O auto-set "https://raw.githubusercontent.com/Ilhamstoress/SSH-XRAY/main/data/auto-set.sh"
chmod +x speedtest
chmod +x xp
chmod +x auto-set
cd
