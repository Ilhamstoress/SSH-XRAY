...
sleep 2
wget -q -O /root/update.sh "https://raw.githubusercontent.com/Ilhamstoress/SSH-XRAY/main/data/update.sh" && chmod +x /root/update.sh
sleep 2
./update.sh
rm /root/update.sh
#rm /opt/.ver
...
echo -e "$COLOR1 $NC ${WH}Client Name ${COLOR1}: ${WH}IlhamStore${NC}"
echo -e "$COLOR1 $NC ${WH}Exp Sc     ${COLOR1}: ${WH}LifeTime${NC}"
echo -e "$COLOR1└─────────────────────────────────────────────────┘$NC"
